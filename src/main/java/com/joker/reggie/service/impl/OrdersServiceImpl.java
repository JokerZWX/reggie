...
import com.joker.reggie.entity.*;
import com.joker.reggie.mapper.OrdersMapper;
import com.joker.reggie.service.*;
...
public class OrdersServiceImpl extends ServiceImpl<OrdersMapper, Orders> implements OrdersService {
    ...
    public R<String> submit(Orders orders) {
        ...
        return R.success("生成订单成功，订单号为{" + orderId + "}");
    }
}
